    ...
    <footer className="bg-background border-t border-border">
      <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="flex items-center space-x-4">
          <Logo size="large" />
         <h2 className="text-sm font-bold bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70">Mechanical Engineering <br/>Students' Association, NIT Durgapur</h2>
        </div>
          ...
          <div>
            ...
            <ul role="list" className="mt-4 space-y-3">
              <li className="flex items-start">
                <MapPin className="mr-2 h-5 w-5 flex-shrink-0 text-primary/70" />
              ...
              <li className="flex items-center">
                <Phone className="mr-2 h-5 w-5 flex-shrink-0 text-primary/70" />
                <span className="text-sm text-muted-foreground">+91 7607549708</span>
              </li>
              <li className="flex items-center">
                <Mail className="mr-2 h-5 w-5 flex-shrink-0 text-primary/70" />
